...
## 2. Description
Github Actions Generator: Builds CI/CD, deployment, and reliability automation for production.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Github Actions Generator in the devops domain.
...
## 8. Example prompts
- /skill github-actions-generator Audit current implementation and propose prioritized improvements.
- /skill github-actions-generator Implement a production-ready baseline with validation steps.
- /skill github-actions-generator Generate artifacts and summarize tradeoffs.
