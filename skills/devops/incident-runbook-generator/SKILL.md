...
## 2. Description
Incident Runbook Generator: Builds CI/CD, deployment, and reliability automation for production.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Incident Runbook Generator in the devops domain.
...
## 8. Example prompts
- /skill incident-runbook-generator Audit current implementation and propose prioritized improvements.
- /skill incident-runbook-generator Implement a production-ready baseline with validation steps.
- /skill incident-runbook-generator Generate artifacts and summarize tradeoffs.
