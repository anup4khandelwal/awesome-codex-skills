...
## 2. Description
Terraform Module Auditor: Builds CI/CD, deployment, and reliability automation for production.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Terraform Module Auditor in the devops domain.
...
## 8. Example prompts
- /skill terraform-module-auditor Audit current implementation and propose prioritized improvements.
- /skill terraform-module-auditor Implement a production-ready baseline with validation steps.
- /skill terraform-module-auditor Generate artifacts and summarize tradeoffs.
