...
## 2. Description
Ci Cd Pipeline Builder: Builds CI/CD, deployment, and reliability automation for production.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Ci Cd Pipeline Builder in the devops domain.
...
## 8. Example prompts
- /skill ci-cd-pipeline-builder Audit current implementation and propose prioritized improvements.
- /skill ci-cd-pipeline-builder Implement a production-ready baseline with validation steps.
- /skill ci-cd-pipeline-builder Generate artifacts and summarize tradeoffs.
