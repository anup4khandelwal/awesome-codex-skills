...
## 2. Description
Dockerfile Generator: Builds CI/CD, deployment, and reliability automation for production.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Dockerfile Generator in the devops domain.
...
## 8. Example prompts
- /skill dockerfile-generator Audit current implementation and propose prioritized improvements.
- /skill dockerfile-generator Implement a production-ready baseline with validation steps.
- /skill dockerfile-generator Generate artifacts and summarize tradeoffs.
