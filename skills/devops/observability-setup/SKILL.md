...
## 2. Description
Observability Setup: Builds CI/CD, deployment, and reliability automation for production.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Observability Setup in the devops domain.
...
## 8. Example prompts
- /skill observability-setup Audit current implementation and propose prioritized improvements.
- /skill observability-setup Implement a production-ready baseline with validation steps.
- /skill observability-setup Generate artifacts and summarize tradeoffs.
