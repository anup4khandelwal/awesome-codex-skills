...
## 2. Description
Service Reliability Checker: Builds CI/CD, deployment, and reliability automation for production.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Service Reliability Checker in the devops domain.
...
## 8. Example prompts
- /skill service-reliability-checker Audit current implementation and propose prioritized improvements.
- /skill service-reliability-checker Implement a production-ready baseline with validation steps.
- /skill service-reliability-checker Generate artifacts and summarize tradeoffs.
