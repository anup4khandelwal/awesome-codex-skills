...
## 2. Description
Release Automation Builder: Builds CI/CD, deployment, and reliability automation for production.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Release Automation Builder in the devops domain.
...
## 8. Example prompts
- /skill release-automation-builder Audit current implementation and propose prioritized improvements.
- /skill release-automation-builder Implement a production-ready baseline with validation steps.
- /skill release-automation-builder Generate artifacts and summarize tradeoffs.
