## 1. Skill Name
infrastructure-as-code-scaffolder

## 2. Description
Infrastructure As Code Scaffolder: Builds CI/CD, deployment, and reliability automation for production.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Infrastructure As Code Scaffolder in the devops domain.
...
- docker, kubectl, terraform, gh, GitHub Actions
- rg --files
- rg "pattern"
- git status
- git diff
...
## 8. Example prompts
- /skill infrastructure-as-code-scaffolder Audit current implementation and propose prioritized improvements.
- /skill infrastructure-as-code-scaffolder Implement a production-ready baseline with validation steps.
- /skill infrastructure-as-code-scaffolder Generate artifacts and summarize tradeoffs.
