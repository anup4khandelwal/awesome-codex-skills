## 1. Skill Name
secrets-management-bootstrapper

## 2. Description
Secrets Management Bootstrapper: Builds CI/CD, deployment, and reliability automation for production.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Secrets Management Bootstrapper in the devops domain.
...
## 8. Example prompts
- /skill secrets-management-bootstrapper Audit current implementation and propose prioritized improvements.
- /skill secrets-management-bootstrapper Implement a production-ready baseline with validation steps.
- /skill secrets-management-bootstrapper Generate artifacts and summarize tradeoffs.
