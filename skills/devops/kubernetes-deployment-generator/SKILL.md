...
## 2. Description
Kubernetes Deployment Generator: Builds CI/CD, deployment, and reliability automation for production.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Kubernetes Deployment Generator in the devops domain.
...
## 8. Example prompts
- /skill kubernetes-deployment-generator Audit current implementation and propose prioritized improvements.
- /skill kubernetes-deployment-generator Implement a production-ready baseline with validation steps.
- /skill kubernetes-deployment-generator Generate artifacts and summarize tradeoffs.
