...
## 2. Description
Responsive Layout Fixer: Improves web UX quality, performance, and accessibility.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Responsive Layout Fixer in the frontend domain.
...
## 8. Example prompts
- /skill responsive-layout-fixer Audit current implementation and propose prioritized improvements.
- /skill responsive-layout-fixer Implement a production-ready baseline with validation steps.
- /skill responsive-layout-fixer Generate artifacts and summarize tradeoffs.
