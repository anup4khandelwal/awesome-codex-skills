## 1. Skill Name
web-vitals-remediator

## 2. Description
Web Vitals Remediator: Improves web UX quality, performance, and accessibility.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Web Vitals Remediator in the frontend domain.
...
## 8. Example prompts
- /skill web-vitals-remediator Audit current implementation and propose prioritized improvements.
- /skill web-vitals-remediator Implement a production-ready baseline with validation steps.
- /skill web-vitals-remediator Generate artifacts and summarize tradeoffs.
