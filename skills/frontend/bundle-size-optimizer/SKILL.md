...
## 2. Description
Bundle Size Optimizer: Improves web UX quality, performance, and accessibility.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Bundle Size Optimizer in the frontend domain.
...
## 8. Example prompts
- /skill bundle-size-optimizer Audit current implementation and propose prioritized improvements.
- /skill bundle-size-optimizer Implement a production-ready baseline with validation steps.
- /skill bundle-size-optimizer Generate artifacts and summarize tradeoffs.
