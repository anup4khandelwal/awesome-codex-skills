...
## 2. Description
State Management Migrator: Improves web UX quality, performance, and accessibility.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with State Management Migrator in the frontend domain.
...
## 8. Example prompts
- /skill state-management-migrator Audit current implementation and propose prioritized improvements.
- /skill state-management-migrator Implement a production-ready baseline with validation steps.
- /skill state-management-migrator Generate artifacts and summarize tradeoffs.
