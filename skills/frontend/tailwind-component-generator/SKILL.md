...
## 2. Description
Tailwind Component Generator: Improves web UX quality, performance, and accessibility.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Tailwind Component Generator in the frontend domain.
...
## 8. Example prompts
- /skill tailwind-component-generator Audit current implementation and propose prioritized improvements.
- /skill tailwind-component-generator Implement a production-ready baseline with validation steps.
- /skill tailwind-component-generator Generate artifacts and summarize tradeoffs.
