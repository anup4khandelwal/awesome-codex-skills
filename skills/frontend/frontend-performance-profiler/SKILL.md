...
## 2. Description
Frontend Performance Profiler: Improves web UX quality, performance, and accessibility.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Frontend Performance Profiler in the frontend domain.
...
## 8. Example prompts
- /skill frontend-performance-profiler Audit current implementation and propose prioritized improvements.
- /skill frontend-performance-profiler Implement a production-ready baseline with validation steps.
- /skill frontend-performance-profiler Generate artifacts and summarize tradeoffs.
