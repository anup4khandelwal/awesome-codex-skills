...
## 2. Description
Accessibility Auditor: Improves web UX quality, performance, and accessibility.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Accessibility Auditor in the frontend domain.
...
## 8. Example prompts
- /skill accessibility-auditor Audit current implementation and propose prioritized improvements.
- /skill accessibility-auditor Implement a production-ready baseline with validation steps.
- /skill accessibility-auditor Generate artifacts and summarize tradeoffs.
