...
## 2. Description
Storybook Story Generator: Improves web UX quality, performance, and accessibility.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Storybook Story Generator in the frontend domain.
...
## 8. Example prompts
- /skill storybook-story-generator Audit current implementation and propose prioritized improvements.
- /skill storybook-story-generator Implement a production-ready baseline with validation steps.
- /skill storybook-story-generator Generate artifacts and summarize tradeoffs.
