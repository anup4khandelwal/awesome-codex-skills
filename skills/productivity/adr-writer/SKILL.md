...
## 2. Description
Adr Writer: Automates engineering operations, collaboration, and delivery workflows.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Adr Writer in the productivity domain.
...
## 8. Example prompts
- /skill adr-writer Audit current implementation and propose prioritized improvements.
- /skill adr-writer Implement a production-ready baseline with validation steps.
- /skill adr-writer Generate artifacts and summarize tradeoffs.
