...
## 2. Description
Dependency Update Planner: Automates engineering operations, collaboration, and delivery workflows.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Dependency Update Planner in the productivity domain.
...
## 8. Example prompts
- /skill dependency-update-planner Audit current implementation and propose prioritized improvements.
- /skill dependency-update-planner Implement a production-ready baseline with validation steps.
- /skill dependency-update-planner Generate artifacts and summarize tradeoffs.
