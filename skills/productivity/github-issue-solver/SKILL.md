...
## 2. Description
Github Issue Solver: Automates engineering operations, collaboration, and delivery workflows.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Github Issue Solver in the productivity domain.
...
## 8. Example prompts
- /skill github-issue-solver Audit current implementation and propose prioritized improvements.
- /skill github-issue-solver Implement a production-ready baseline with validation steps.
- /skill github-issue-solver Generate artifacts and summarize tradeoffs.
