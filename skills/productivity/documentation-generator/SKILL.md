...
## 2. Description
Documentation Generator: Automates engineering operations, collaboration, and delivery workflows.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Documentation Generator in the productivity domain.
...
## 8. Example prompts
- /skill documentation-generator Audit current implementation and propose prioritized improvements.
- /skill documentation-generator Implement a production-ready baseline with validation steps.
- /skill documentation-generator Generate artifacts and summarize tradeoffs.
