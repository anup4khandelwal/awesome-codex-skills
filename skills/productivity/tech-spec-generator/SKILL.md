...
## 2. Description
Tech Spec Generator: Automates engineering operations, collaboration, and delivery workflows.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Tech Spec Generator in the productivity domain.
...
## 8. Example prompts
- /skill tech-spec-generator Audit current implementation and propose prioritized improvements.
- /skill tech-spec-generator Implement a production-ready baseline with validation steps.
- /skill tech-spec-generator Generate artifacts and summarize tradeoffs.
