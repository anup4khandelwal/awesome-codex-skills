...
## 2. Description
Changelog Generator: Automates engineering operations, collaboration, and delivery workflows.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Changelog Generator in the productivity domain.
...
## 8. Example prompts
- /skill changelog-generator Audit current implementation and propose prioritized improvements.
- /skill changelog-generator Implement a production-ready baseline with validation steps.
- /skill changelog-generator Generate artifacts and summarize tradeoffs.
