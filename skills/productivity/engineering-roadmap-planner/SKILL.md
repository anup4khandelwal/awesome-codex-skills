...
## 2. Description
Engineering Roadmap Planner: Automates engineering operations, collaboration, and delivery workflows.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Engineering Roadmap Planner in the productivity domain.
...
## 8. Example prompts
- /skill engineering-roadmap-planner Audit current implementation and propose prioritized improvements.
- /skill engineering-roadmap-planner Implement a production-ready baseline with validation steps.
- /skill engineering-roadmap-planner Generate artifacts and summarize tradeoffs.
