## 1. Skill Name
developer-oncall-assistant

## 2. Description
Developer Oncall Assistant: Automates engineering operations, collaboration, and delivery workflows.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Developer Oncall Assistant in the productivity domain.
...
## 8. Example prompts
- /skill developer-oncall-assistant Audit current implementation and propose prioritized improvements.
- /skill developer-oncall-assistant Implement a production-ready baseline with validation steps.
- /skill developer-oncall-assistant Generate artifacts and summarize tradeoffs.
