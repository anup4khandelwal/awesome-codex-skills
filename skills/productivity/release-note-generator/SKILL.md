...
## 2. Description
Release Note Generator: Automates engineering operations, collaboration, and delivery workflows.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Release Note Generator in the productivity domain.
...
## 8. Example prompts
- /skill release-note-generator Audit current implementation and propose prioritized improvements.
- /skill release-note-generator Implement a production-ready baseline with validation steps.
- /skill release-note-generator Generate artifacts and summarize tradeoffs.
