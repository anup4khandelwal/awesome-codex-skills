...
## 2. Description
Security Regression Tester: Finds and mitigates application and supply-chain security risks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Security Regression Tester in the security domain.
...
## 8. Example prompts
- /skill security-regression-tester Audit current implementation and propose prioritized improvements.
- /skill security-regression-tester Implement a production-ready baseline with validation steps.
- /skill security-regression-tester Generate artifacts and summarize tradeoffs.
