...
## 2. Description
Oauth Scope Auditor: Finds and mitigates application and supply-chain security risks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Oauth Scope Auditor in the security domain.
...
## 8. Example prompts
- /skill oauth-scope-auditor Audit current implementation and propose prioritized improvements.
- /skill oauth-scope-auditor Implement a production-ready baseline with validation steps.
- /skill oauth-scope-auditor Generate artifacts and summarize tradeoffs.
