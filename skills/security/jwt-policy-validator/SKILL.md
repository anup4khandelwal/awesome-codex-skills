## 1. Skill Name
jwt-policy-validator

## 2. Description
Jwt Policy Validator: Finds and mitigates application and supply-chain security risks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Jwt Policy Validator in the security domain.
...
## 8. Example prompts
- /skill jwt-policy-validator Audit current implementation and propose prioritized improvements.
- /skill jwt-policy-validator Implement a production-ready baseline with validation steps.
- /skill jwt-policy-validator Generate artifacts and summarize tradeoffs.
