...
## 2. Description
Secrets Detector: Finds and mitigates application and supply-chain security risks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Secrets Detector in the security domain.
...
## 8. Example prompts
- /skill secrets-detector Audit current implementation and propose prioritized improvements.
- /skill secrets-detector Implement a production-ready baseline with validation steps.
- /skill secrets-detector Generate artifacts and summarize tradeoffs.
