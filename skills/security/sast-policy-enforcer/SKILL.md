## 1. Skill Name
sast-policy-enforcer

## 2. Description
Sast Policy Enforcer: Finds and mitigates application and supply-chain security risks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Sast Policy Enforcer in the security domain.
...
## 8. Example prompts
- /skill sast-policy-enforcer Audit current implementation and propose prioritized improvements.
- /skill sast-policy-enforcer Implement a production-ready baseline with validation steps.
- /skill sast-policy-enforcer Generate artifacts and summarize tradeoffs.
