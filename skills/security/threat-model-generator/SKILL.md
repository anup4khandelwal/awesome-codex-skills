...
## 2. Description
Threat Model Generator: Finds and mitigates application and supply-chain security risks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Threat Model Generator in the security domain.
...
## 8. Example prompts
- /skill threat-model-generator Audit current implementation and propose prioritized improvements.
- /skill threat-model-generator Implement a production-ready baseline with validation steps.
- /skill threat-model-generator Generate artifacts and summarize tradeoffs.
