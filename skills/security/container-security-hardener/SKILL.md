...
## 2. Description
Container Security Hardener: Finds and mitigates application and supply-chain security risks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Container Security Hardener in the security domain.
...
## 8. Example prompts
- /skill container-security-hardener Audit current implementation and propose prioritized improvements.
- /skill container-security-hardener Implement a production-ready baseline with validation steps.
- /skill container-security-hardener Generate artifacts and summarize tradeoffs.
