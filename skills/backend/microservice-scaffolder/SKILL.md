...
## 2. Description
Microservice Scaffolder: Accelerates API and service engineering with scalable patterns.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Microservice Scaffolder in the backend domain.
...
## 8. Example prompts
- /skill microservice-scaffolder Audit current implementation and propose prioritized improvements.
- /skill microservice-scaffolder Implement a production-ready baseline with validation steps.
- /skill microservice-scaffolder Generate artifacts and summarize tradeoffs.
