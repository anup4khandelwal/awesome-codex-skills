...
## 2. Description
Graphql Schema Builder: Accelerates API and service engineering with scalable patterns.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Graphql Schema Builder in the backend domain.
...
## 8. Example prompts
- /skill graphql-schema-builder Audit current implementation and propose prioritized improvements.
- /skill graphql-schema-builder Implement a production-ready baseline with validation steps.
- /skill graphql-schema-builder Generate artifacts and summarize tradeoffs.
