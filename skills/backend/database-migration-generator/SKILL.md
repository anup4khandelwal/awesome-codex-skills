...
## 2. Description
Database Migration Generator: Accelerates API and service engineering with scalable patterns.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Database Migration Generator in the backend domain.
...
## 8. Example prompts
- /skill database-migration-generator Audit current implementation and propose prioritized improvements.
- /skill database-migration-generator Implement a production-ready baseline with validation steps.
- /skill database-migration-generator Generate artifacts and summarize tradeoffs.
