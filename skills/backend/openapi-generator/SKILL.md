...
## 2. Description
Openapi Generator: Accelerates API and service engineering with scalable patterns.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Openapi Generator in the backend domain.
...
## 8. Example prompts
- /skill openapi-generator Audit current implementation and propose prioritized improvements.
- /skill openapi-generator Implement a production-ready baseline with validation steps.
- /skill openapi-generator Generate artifacts and summarize tradeoffs.
