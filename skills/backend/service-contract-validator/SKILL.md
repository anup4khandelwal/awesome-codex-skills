...
## 2. Description
Service Contract Validator: Accelerates API and service engineering with scalable patterns.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Service Contract Validator in the backend domain.
...
## 8. Example prompts
- /skill service-contract-validator Audit current implementation and propose prioritized improvements.
- /skill service-contract-validator Implement a production-ready baseline with validation steps.
- /skill service-contract-validator Generate artifacts and summarize tradeoffs.
