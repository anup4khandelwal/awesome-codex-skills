...
## 2. Description
Caching Strategy Advisor: Accelerates API and service engineering with scalable patterns.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Caching Strategy Advisor in the backend domain.
...
## 8. Example prompts
- /skill caching-strategy-advisor Audit current implementation and propose prioritized improvements.
- /skill caching-strategy-advisor Implement a production-ready baseline with validation steps.
- /skill caching-strategy-advisor Generate artifacts and summarize tradeoffs.
