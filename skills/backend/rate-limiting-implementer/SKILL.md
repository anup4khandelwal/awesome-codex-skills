## 1. Skill Name
rate-limiting-implementer

## 2. Description
Rate Limiting Implementer: Accelerates API and service engineering with scalable patterns.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Rate Limiting Implementer in the backend domain.
...
## 8. Example prompts
- /skill rate-limiting-implementer Audit current implementation and propose prioritized improvements.
- /skill rate-limiting-implementer Implement a production-ready baseline with validation steps.
- /skill rate-limiting-implementer Generate artifacts and summarize tradeoffs.
