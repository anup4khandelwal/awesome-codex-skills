...
## 2. Description
Api Endpoint Generator: Accelerates API and service engineering with scalable patterns.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Api Endpoint Generator in the backend domain.
...
## 8. Example prompts
- /skill api-endpoint-generator Audit current implementation and propose prioritized improvements.
- /skill api-endpoint-generator Implement a production-ready baseline with validation steps.
- /skill api-endpoint-generator Generate artifacts and summarize tradeoffs.
