...
## 2. Description
Contract Test Generator: Designs and automates reliable tests with measurable confidence.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Contract Test Generator in the testing domain.
...
## 8. Example prompts
- /skill contract-test-generator Audit current implementation and propose prioritized improvements.
- /skill contract-test-generator Implement a production-ready baseline with validation steps.
- /skill contract-test-generator Generate artifacts and summarize tradeoffs.
