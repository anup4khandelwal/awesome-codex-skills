...
## 2. Description
Integration Test Builder: Designs and automates reliable tests with measurable confidence.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Integration Test Builder in the testing domain.
...
## 8. Example prompts
- /skill integration-test-builder Audit current implementation and propose prioritized improvements.
- /skill integration-test-builder Implement a production-ready baseline with validation steps.
- /skill integration-test-builder Generate artifacts and summarize tradeoffs.
