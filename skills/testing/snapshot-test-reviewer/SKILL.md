...
## 2. Description
Snapshot Test Reviewer: Designs and automates reliable tests with measurable confidence.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Snapshot Test Reviewer in the testing domain.
...
## 8. Example prompts
- /skill snapshot-test-reviewer Audit current implementation and propose prioritized improvements.
- /skill snapshot-test-reviewer Implement a production-ready baseline with validation steps.
- /skill snapshot-test-reviewer Generate artifacts and summarize tradeoffs.
