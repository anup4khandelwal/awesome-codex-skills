## 1. Skill Name
performance-test-harness-builder

## 2. Description
Performance Test Harness Builder: Designs and automates reliable tests with measurable confidence.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Performance Test Harness Builder in the testing domain.
...
## 8. Example prompts
- /skill performance-test-harness-builder Audit current implementation and propose prioritized improvements.
- /skill performance-test-harness-builder Implement a production-ready baseline with validation steps.
- /skill performance-test-harness-builder Generate artifacts and summarize tradeoffs.
