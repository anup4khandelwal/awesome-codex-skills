...
## 2. Description
Mutation Testing Runner: Designs and automates reliable tests with measurable confidence.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Mutation Testing Runner in the testing domain.
...
## 8. Example prompts
- /skill mutation-testing-runner Audit current implementation and propose prioritized improvements.
- /skill mutation-testing-runner Implement a production-ready baseline with validation steps.
- /skill mutation-testing-runner Generate artifacts and summarize tradeoffs.
