...
## 2. Description
Flaky Test Detector: Designs and automates reliable tests with measurable confidence.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Flaky Test Detector in the testing domain.
...
## 8. Example prompts
- /skill flaky-test-detector Audit current implementation and propose prioritized improvements.
- /skill flaky-test-detector Implement a production-ready baseline with validation steps.
- /skill flaky-test-detector Generate artifacts and summarize tradeoffs.
