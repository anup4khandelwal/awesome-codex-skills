...
## 2. Description
Test Data Factory Builder: Designs and automates reliable tests with measurable confidence.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Test Data Factory Builder in the testing domain.
...
## 8. Example prompts
- /skill test-data-factory-builder Audit current implementation and propose prioritized improvements.
- /skill test-data-factory-builder Implement a production-ready baseline with validation steps.
- /skill test-data-factory-builder Generate artifacts and summarize tradeoffs.
