...
## 2. Description
Playwright Test Generator: Designs and automates reliable tests with measurable confidence.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Playwright Test Generator in the testing domain.
...
## 8. Example prompts
- /skill playwright-test-generator Audit current implementation and propose prioritized improvements.
- /skill playwright-test-generator Implement a production-ready baseline with validation steps.
- /skill playwright-test-generator Generate artifacts and summarize tradeoffs.
