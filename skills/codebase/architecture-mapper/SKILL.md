...
## 2. Description
Architecture Mapper: Maps and improves repository architecture, dependencies, and maintainability.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Architecture Mapper in the codebase domain.
...
## 8. Example prompts
- /skill architecture-mapper Audit current implementation and propose prioritized improvements.
- /skill architecture-mapper Implement a production-ready baseline with validation steps.
- /skill architecture-mapper Generate artifacts and summarize tradeoffs.
