...
## 2. Description
Onboarding Path Generator: Maps and improves repository architecture, dependencies, and maintainability.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Onboarding Path Generator in the codebase domain.
...
## 8. Example prompts
- /skill onboarding-path-generator Audit current implementation and propose prioritized improvements.
- /skill onboarding-path-generator Implement a production-ready baseline with validation steps.
- /skill onboarding-path-generator Generate artifacts and summarize tradeoffs.
