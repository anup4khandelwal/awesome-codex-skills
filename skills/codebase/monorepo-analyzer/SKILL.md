...
## 2. Description
Monorepo Analyzer: Maps and improves repository architecture, dependencies, and maintainability.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Monorepo Analyzer in the codebase domain.
...
## 8. Example prompts
- /skill monorepo-analyzer Audit current implementation and propose prioritized improvements.
- /skill monorepo-analyzer Implement a production-ready baseline with validation steps.
- /skill monorepo-analyzer Generate artifacts and summarize tradeoffs.
