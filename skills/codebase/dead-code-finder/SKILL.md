...
## 2. Description
Dead Code Finder: Maps and improves repository architecture, dependencies, and maintainability.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Dead Code Finder in the codebase domain.
...
## 8. Example prompts
- /skill dead-code-finder Audit current implementation and propose prioritized improvements.
- /skill dead-code-finder Implement a production-ready baseline with validation steps.
- /skill dead-code-finder Generate artifacts and summarize tradeoffs.
