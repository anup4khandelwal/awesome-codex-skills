...
## 2. Description
Api Surface Indexer: Maps and improves repository architecture, dependencies, and maintainability.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Api Surface Indexer in the codebase domain.
...
## 8. Example prompts
- /skill api-surface-indexer Audit current implementation and propose prioritized improvements.
- /skill api-surface-indexer Implement a production-ready baseline with validation steps.
- /skill api-surface-indexer Generate artifacts and summarize tradeoffs.
