...
## 2. Description
Legacy Modernization Planner: Maps and improves repository architecture, dependencies, and maintainability.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Legacy Modernization Planner in the codebase domain.
...
## 8. Example prompts
- /skill legacy-modernization-planner Audit current implementation and propose prioritized improvements.
- /skill legacy-modernization-planner Implement a production-ready baseline with validation steps.
- /skill legacy-modernization-planner Generate artifacts and summarize tradeoffs.
