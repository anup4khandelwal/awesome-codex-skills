...
## 2. Description
Code Smell Detector: Maps and improves repository architecture, dependencies, and maintainability.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Code Smell Detector in the codebase domain.
...
## 8. Example prompts
- /skill code-smell-detector Audit current implementation and propose prioritized improvements.
- /skill code-smell-detector Implement a production-ready baseline with validation steps.
- /skill code-smell-detector Generate artifacts and summarize tradeoffs.
