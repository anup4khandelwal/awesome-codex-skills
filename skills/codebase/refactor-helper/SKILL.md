...
## 2. Description
Refactor Helper: Maps and improves repository architecture, dependencies, and maintainability.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Refactor Helper in the codebase domain.
...
## 8. Example prompts
- /skill refactor-helper Audit current implementation and propose prioritized improvements.
- /skill refactor-helper Implement a production-ready baseline with validation steps.
- /skill refactor-helper Generate artifacts and summarize tradeoffs.
