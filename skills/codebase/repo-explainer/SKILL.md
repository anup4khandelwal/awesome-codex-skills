...
## 2. Description
Repo Explainer: Maps and improves repository architecture, dependencies, and maintainability.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Repo Explainer in the codebase domain.
...
## 8. Example prompts
- /skill repo-explainer Audit current implementation and propose prioritized improvements.
- /skill repo-explainer Implement a production-ready baseline with validation steps.
- /skill repo-explainer Generate artifacts and summarize tradeoffs.
