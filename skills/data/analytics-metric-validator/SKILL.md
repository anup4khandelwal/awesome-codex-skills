## 1. Skill Name
analytics-metric-validator

## 2. Description
Analytics Metric Validator: Designs trusted data pipelines, schemas, and quality checks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Analytics Metric Validator in the data domain.
...
## 8. Example prompts
- /skill analytics-metric-validator Audit current implementation and propose prioritized improvements.
- /skill analytics-metric-validator Implement a production-ready baseline with validation steps.
- /skill analytics-metric-validator Generate artifacts and summarize tradeoffs.
