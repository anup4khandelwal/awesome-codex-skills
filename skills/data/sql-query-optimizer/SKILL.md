...
## 2. Description
Sql Query Optimizer: Designs trusted data pipelines, schemas, and quality checks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Sql Query Optimizer in the data domain.
...
## 8. Example prompts
- /skill sql-query-optimizer Audit current implementation and propose prioritized improvements.
- /skill sql-query-optimizer Implement a production-ready baseline with validation steps.
- /skill sql-query-optimizer Generate artifacts and summarize tradeoffs.
