...
## 2. Description
Db Schema Designer: Designs trusted data pipelines, schemas, and quality checks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Db Schema Designer in the data domain.
...
## 8. Example prompts
- /skill db-schema-designer Audit current implementation and propose prioritized improvements.
- /skill db-schema-designer Implement a production-ready baseline with validation steps.
- /skill db-schema-designer Generate artifacts and summarize tradeoffs.
