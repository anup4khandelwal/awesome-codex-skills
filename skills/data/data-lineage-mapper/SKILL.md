...
## 2. Description
Data Lineage Mapper: Designs trusted data pipelines, schemas, and quality checks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Data Lineage Mapper in the data domain.
...
## 8. Example prompts
- /skill data-lineage-mapper Audit current implementation and propose prioritized improvements.
- /skill data-lineage-mapper Implement a production-ready baseline with validation steps.
- /skill data-lineage-mapper Generate artifacts and summarize tradeoffs.
