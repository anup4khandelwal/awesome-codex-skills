## 1. Skill Name
cdc-pipeline-planner

## 2. Description
Cdc Pipeline Planner: Designs trusted data pipelines, schemas, and quality checks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Cdc Pipeline Planner in the data domain.
...
## 8. Example prompts
- /skill cdc-pipeline-planner Audit current implementation and propose prioritized improvements.
- /skill cdc-pipeline-planner Implement a production-ready baseline with validation steps.
- /skill cdc-pipeline-planner Generate artifacts and summarize tradeoffs.
