...
## 2. Description
Warehouse Model Builder: Designs trusted data pipelines, schemas, and quality checks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Warehouse Model Builder in the data domain.
...
## 8. Example prompts
- /skill warehouse-model-builder Audit current implementation and propose prioritized improvements.
- /skill warehouse-model-builder Implement a production-ready baseline with validation steps.
- /skill warehouse-model-builder Generate artifacts and summarize tradeoffs.
