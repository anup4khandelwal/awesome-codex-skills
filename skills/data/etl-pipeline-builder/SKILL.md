...
## 2. Description
Etl Pipeline Builder: Designs trusted data pipelines, schemas, and quality checks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Etl Pipeline Builder in the data domain.
...
## 8. Example prompts
- /skill etl-pipeline-builder Audit current implementation and propose prioritized improvements.
- /skill etl-pipeline-builder Implement a production-ready baseline with validation steps.
- /skill etl-pipeline-builder Generate artifacts and summarize tradeoffs.
