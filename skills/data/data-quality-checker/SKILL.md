...
## 2. Description
Data Quality Checker: Designs trusted data pipelines, schemas, and quality checks.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Data Quality Checker in the data domain.
...
## 8. Example prompts
- /skill data-quality-checker Audit current implementation and propose prioritized improvements.
- /skill data-quality-checker Implement a production-ready baseline with validation steps.
- /skill data-quality-checker Generate artifacts and summarize tradeoffs.
