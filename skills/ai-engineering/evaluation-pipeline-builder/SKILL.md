...
## 2. Description
Evaluation Pipeline Builder: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Evaluation Pipeline Builder in the ai-engineering domain.
...
## 8. Example prompts
- /skill evaluation-pipeline-builder Audit current implementation and propose prioritized improvements.
- /skill evaluation-pipeline-builder Implement a production-ready baseline with validation steps.
- /skill evaluation-pipeline-builder Generate artifacts and summarize tradeoffs.
