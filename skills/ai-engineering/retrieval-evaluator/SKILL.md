...
## 2. Description
Retrieval Evaluator: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Retrieval Evaluator in the ai-engineering domain.
...
## 8. Example prompts
- /skill retrieval-evaluator Audit current implementation and propose prioritized improvements.
- /skill retrieval-evaluator Implement a production-ready baseline with validation steps.
- /skill retrieval-evaluator Generate artifacts and summarize tradeoffs.
