...
## 2. Description
Tool Calling Orchestrator: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Tool Calling Orchestrator in the ai-engineering domain.
...
## 8. Example prompts
- /skill tool-calling-orchestrator Audit current implementation and propose prioritized improvements.
- /skill tool-calling-orchestrator Implement a production-ready baseline with validation steps.
- /skill tool-calling-orchestrator Generate artifacts and summarize tradeoffs.
