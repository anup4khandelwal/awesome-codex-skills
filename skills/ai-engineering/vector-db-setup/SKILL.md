...
## 2. Description
Vector Db Setup: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Vector Db Setup in the ai-engineering domain.
...
## 8. Example prompts
- /skill vector-db-setup Audit current implementation and propose prioritized improvements.
- /skill vector-db-setup Implement a production-ready baseline with validation steps.
- /skill vector-db-setup Generate artifacts and summarize tradeoffs.
