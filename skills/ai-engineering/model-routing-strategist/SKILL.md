## 1. Skill Name
model-routing-strategist

## 2. Description
Model Routing Strategist: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Model Routing Strategist in the ai-engineering domain.
...
## 8. Example prompts
- /skill model-routing-strategist Audit current implementation and propose prioritized improvements.
- /skill model-routing-strategist Implement a production-ready baseline with validation steps.
- /skill model-routing-strategist Generate artifacts and summarize tradeoffs.
