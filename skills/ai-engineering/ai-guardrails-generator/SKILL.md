...
## 2. Description
Ai Guardrails Generator: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Ai Guardrails Generator in the ai-engineering domain.
...
## 8. Example prompts
- /skill ai-guardrails-generator Audit current implementation and propose prioritized improvements.
- /skill ai-guardrails-generator Implement a production-ready baseline with validation steps.
- /skill ai-guardrails-generator Generate artifacts and summarize tradeoffs.
