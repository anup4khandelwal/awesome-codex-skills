...
## 2. Description
Agent Memory Designer: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Agent Memory Designer in the ai-engineering domain.
...
## 8. Example prompts
- /skill agent-memory-designer Audit current implementation and propose prioritized improvements.
- /skill agent-memory-designer Implement a production-ready baseline with validation steps.
- /skill agent-memory-designer Generate artifacts and summarize tradeoffs.
