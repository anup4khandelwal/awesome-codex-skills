...
## 2. Description
Synthetic Dataset Generator: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Synthetic Dataset Generator in the ai-engineering domain.
...
## 8. Example prompts
- /skill synthetic-dataset-generator Audit current implementation and propose prioritized improvements.
- /skill synthetic-dataset-generator Implement a production-ready baseline with validation steps.
- /skill synthetic-dataset-generator Generate artifacts and summarize tradeoffs.
