...
## 2. Description
Rag Pipeline Builder: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Rag Pipeline Builder in the ai-engineering domain.
...
## 8. Example prompts
- /skill rag-pipeline-builder Audit current implementation and propose prioritized improvements.
- /skill rag-pipeline-builder Implement a production-ready baseline with validation steps.
- /skill rag-pipeline-builder Generate artifacts and summarize tradeoffs.
