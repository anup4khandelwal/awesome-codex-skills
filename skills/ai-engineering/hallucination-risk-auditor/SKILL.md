## 1. Skill Name
hallucination-risk-auditor

## 2. Description
Hallucination Risk Auditor: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Hallucination Risk Auditor in the ai-engineering domain.
...
## 8. Example prompts
- /skill hallucination-risk-auditor Audit current implementation and propose prioritized improvements.
- /skill hallucination-risk-auditor Implement a production-ready baseline with validation steps.
- /skill hallucination-risk-auditor Generate artifacts and summarize tradeoffs.
