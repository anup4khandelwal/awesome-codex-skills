...
## 2. Description
Langgraph Agent Builder: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Langgraph Agent Builder in the ai-engineering domain.
...
## 8. Example prompts
- /skill langgraph-agent-builder Audit current implementation and propose prioritized improvements.
- /skill langgraph-agent-builder Implement a production-ready baseline with validation steps.
- /skill langgraph-agent-builder Generate artifacts and summarize tradeoffs.
