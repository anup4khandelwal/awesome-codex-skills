...
## 2. Description
Agent Observability Setup: Implements robust LLM and agent workflows with controls and evaluation.

## 3. When the AI agent should use this skill
Use this skill when a request aligns with Agent Observability Setup in the ai-engineering domain.
...
## 8. Example prompts
- /skill agent-observability-setup Audit current implementation and propose prioritized improvements.
- /skill agent-observability-setup Implement a production-ready baseline with validation steps.
- /skill agent-observability-setup Generate artifacts and summarize tradeoffs.
